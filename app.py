...
def predict():
    ...
    features[2] = d2.get(features[2])
    d3 = {'Entrepreneur': 0, 'Other': 1, 'Salaried': 2, 'Self-Employed': 3}
    features[3] = d3.get(features[3])
    d4 = {'X1': 0, 'X2': 1, 'X3': 2, 'X4': 3}
    features[4] = d4.get(features[4])
    d5 = {'No': 0, 'Not Known': 1, 'Yes': 2}
    features[6] = d5.get(features[6])
    d6 = {'False': 0, 'True': 1}
    features[8] = d6.get(features[8])
    ...
    #         final_features.append(1)
    #     elif 'X' in i:
    #         final_features.append(d4.get(i))
    #     elif i == 'Yes':
    #         final_features.append(2)
    #     elif i == 'No':
    #         final_features.append(0)
    ...
    final_features = np.array(features).reshape(-1, 9)
